...
export default function Header() {
  ...
  const signboardItems = [
    { id: 1, name: 'LED Signboards', href: '/signboards/led' },
    { id: 2, name: 'Neon Signs', href: '/signboards/neon' },
    { id: 3, name: 'Acrylic Signs', href: '/signboards/acrylic' },
    { id: 4, name: '3D Letters', href: '/signboards/3d-letters' },
    { id: 5, name: 'Shop Signs', href: '/signboards/shop' },
    { id: 6, name: ' LED Signboards', href: '/signboards/led' },
    { id: 7, name: ' Neon Signs', href: '/signboards/neon' },
    { id: 8, name: ' Acrylic Signs', href: '/signboards/acrylic' },
    { id: 9, name: ' 3D Letters', href: '/signboards/3d-letters' },
    { id: 10, name: ' Shop Signs', href: '/signboards/shop' },
     { id: 6, name: ' LED Signboards', href: '/signboards/led' },
    { id: 7, name: ' Neon Signs', href: '/signboards/neon' },
    { id: 8, name: ' Acrylic Signs', href: '/signboards/acrylic' },
    { id: 9, name: ' 3D Letters', href: '/signboards/3d-letters' },
  ...
  const stickerItems = [
    { id: 1, name: 'Vinyl Stickers', href: '/stickers/vinyl' },
    { id: 2, name: 'Window Graphics', href: '/stickers/window' },
    { id: 3, name: 'Vehicle Wraps', href: '/stickers/vehicle' },
    { id: 4, name: 'Wall Decals', href: '/stickers/wall' },
    { id: 5, name: 'Custom Stickers', href: '/stickers/custom' },
  ];
      ...
      <nav className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-4">
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center">
            <Link href="/" className="text-2xl font-bold bg-gradient-to-r from-[#A4C32C] to-[#7A9C1A] bg-clip-text text-transparent hover:scale-105 transition-transform duration-200">
              CHEEMA ADVERTISING
            </Link>
          </div>
